...
# To me removing LOP seems weird seeing as I need to for the rest of the code but I've followed the instructions on the coursework. It's commented out here so is functionally irrelevant.
